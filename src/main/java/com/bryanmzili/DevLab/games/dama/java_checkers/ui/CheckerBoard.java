 ...
 */
package com.bryanmzili.DevLab.games.dama.java_checkers.ui;

import com.bryanmzili.DevLab.games.dama.java_checkers.model.*;
import com.bryanmzili.DevLab.games.dama.java_checkers.ui.*;
import com.bryanmzili.DevLab.games.dama.java_checkers.network.*;
import com.bryanmzili.DevLab.games.dama.java_checkers.logic.*;
...
public class CheckerBoard extends JButton {
    ...
    // code added by Bryan
    public void simulateClickCell(int cellX, int cellY) {
        final int W = getWidth(), H = getHeight();
        ...
        int clickX = OFFSET_X + cellX * BOX_SIZE + BOX_SIZE / 2;
        int clickY = OFFSET_Y + cellY * BOX_SIZE + BOX_SIZE / 2;
